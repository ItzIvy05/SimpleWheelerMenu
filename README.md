...
**Do NOT run both at the same time.** Install this **instead of dMenu**, not alongside it.
...
5. Press the keyboard key, mouse button, or controller button you want to assign.
